...
if [ -z "$PURE_DATA_PATCH" ]; then
	...
	case "$1" in
	    "4")
	        PATCH_DATA_DIR="/usr/local/puredata-patches/patches/fourth"
	        ;;
	    "5")
	        PATCH_DATA_DIR="/usr/local/puredata-patches/patches/fifth"
	        ;;
	    "6")
	        PATCH_DATA_DIR="/usr/local/puredata-patches/patches/sixth"
	        ;;
	    "7")
	        PATCH_DATA_DIR="/usr/local/puredata-patches/patches/seventh"
	        ;;
	    "8")
	        PATCH_DATA_DIR="/usr/local/puredata-patches/patches/eighth"
	        ;;
	    #...
	esac
